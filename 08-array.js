...
const v3 = new Array(2024, "String", true);   //  초기값이 있을 때, 어떤 객체(함수도)라도 다 들어간다
...
// console.log(veges.concat(sources));
...
console.log(fruits);
console.log(fruits.splice(2));  //  인수가 1개면 -> 시작 인덱스 ~ 끝까지 추출
console.log(fruits);

fruits = ["Apple", "Banana", "Carot", "Durian"];
console.log(fruits);
console.log(fruits.splice(2, 1));  //  인수가 2개면 -> 시작 인덱스, 갯수
console.log(fruits);

fruits = ["Apple", "Banana", "Carot", "Durian"];
console.log(fruits);
console.log(fruits.splice(2, 1, "Kiwi", "Mango"));  //  인수가 3개면 -> 시작 인덱스, 갯수, 추가할 요소들
console.log(fruits);
...
console.log(fruits);
let slice = fruits.slice(1,2);  //  원본 배열은 유지 (2번 인덱스 앞 까지 멈춤)
console.log(slice);
console.log(fruits);

//  split : 구분자를 기준으로 문자열을 분리 -> 배열로 생성
const str = "JavaScript is something strange than other languages";
let chunks = str.split(" ");    //  공백 기준 분리
console.log(chunks);

console.log("========= sort");
fruits = ["Corot", "Durian", "Apple", "Mango", "Kiwi", "Banana"];
