...
function testForEach() {
    let source = ["Aplle", "Banana", "Carrot", "Drian"];
    ...
    console.log("======= 요소, 인덱스와 함께 콜백 함수도 전달");
...
function testReduce3() {
    ...
    console.log("원본배열:", numbers);
    let evenNumbers = numbers.reduce((acc, value) => {
        if (value % 2 === 0) {
            acc.push(value);
        }
        return acc;
...
function testDataPipeline() {
    ...
    const sortedStudents = filteredStudents.sort((a, b) => a.total - b.total);
    ...
    console.log("학생들의 평균 총점:", avgTotalScore);
